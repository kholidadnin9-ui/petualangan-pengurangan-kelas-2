...
export default function HomeScreen({
  ...
  /*
   * BASE_URL penting untuk GitHub Pages/Vite.
   * Semua gambar berada di folder public/.
   */
  const baseUrl = import.meta.env.BASE_URL;

  const heroImage = `${baseUrl}hero-characters.png`;
  const monkeyImage = `${baseUrl}monkey-happy.png`;
  ...
  return (
    <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-2xl flex-col items-center px-4 pb-8 pt-5">
      ...
      {/* Main wooden title sign */}
      <div className="relative mt-2 w-full max-w-xl px-4 py-2 fade-up">

        <Leaf
          className="leaf-deco leaf-tl"
        />

        <Leaf
          className="leaf-deco leaf-tr"
        />
